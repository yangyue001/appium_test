...
#变现计划
        lr_btn = get_element(self.driver,'lr_btn')
        lr_btn.click()


        bxjh_btn = get_element(self.driver,'bxjh_btn')
        bxjh_btn.click()

        bxjh_more = get_element(self.driver,"bxjh_more")
        bxjh_more.click()


        bxjh_hot_prj =get_element(self.driver,'bxjh_hot_prj')

        bxjh_hot_prj.click()

        bxjh_all_prjs = get_elements(self.driver,'bxjh_all_prj')
        bxjh_all_prj = bxjh_all_prjs[0]
        bxjh_all_prj.click()

        bxjh_fir_prj_joins = get_elements(self.driver,'bxjh_fir_prj_join')
        bxjh_fir_prj_join = bxjh_fir_prj_joins[0]
        bxjh_fir_prj_join.click()

        bxjh_prj_detail_join = get_element(self.driver,'bxjh_prj_detail_join')
        bxjh_prj_detail_join.click()

        bxjh_prj_input = get_element(self.driver,'bxjh_prj_input')
        bxjh_prj_input.click()
        ...
        bxjh_jion_imidiately = get_element(self.driver,'bxjh_jion_imidiately')
        bxjh_jion_imidiately.click()

        bxjh_sure_join = get_element(self.driver,'bxjh_sure_join')
        bxjh_sure_join.click()

        bxjh_keep_join = get_element(self.driver,'bxjh_keep_join')
        bxjh_keep_join.click()
