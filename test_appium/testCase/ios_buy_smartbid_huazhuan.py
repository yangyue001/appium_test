...
class SmartBid_Buy_Huazhuan(unittest.TestCase):
    ...
    def test_buy_smart_one(self):
        ...
        one_transfer_psw = get_element(self.driver, 'one_transfer_psw')
        one_transfer_psw.send_keys(self.one_psw)

        sys_key_down = get_element(self.driver, 'sys_key_down')
        sys_key_down.click()
        one_transfer_agree = get_element(self.driver, 'one_transfer_agree')
        one_transfer_agree.click()

        one_transfer_sure = get_element(self.driver, 'one_transfer_sure')
        one_transfer_sure.click()
    ...
    def runn(self):
        ...
        with open(reportpath, 'wb') as fp:
            try:
                ...
                suit.addTest(SmartBid_Buy_Huazhuan('test_buy_smart_one'))
                if suit is not None:
